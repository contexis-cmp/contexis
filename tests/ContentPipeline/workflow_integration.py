#!/usr/bin/env python3
"""
Workflow Integration Test: ContentPipeline
...
sys.path.append(os.path.join(os.path.dirname(__file__), '../../workflows/ContentPipeline'))

class ContentPipelineWorkflowTest:
    """Integration tests for ContentPipeline workflow"""
    
    def __init__(self):
        self.workflow_name = "ContentPipeline"
        self.workflow_path = Path(__file__).parent.parent.parent / "workflows" / "ContentPipeline"
    ...
    def test_resource_limits(self):
        ...
        assert resources['memory'] == "4Gi"
        assert resources['storage'] == "10Gi"
        assert resources['network'] == "100Mbps"
    ...
    def test_state_persistence(self):
        ...
        assert config['state_persistence'] == true
...
def run_workflow_tests():
    ...
    print(f"Running integration tests for workflow: ContentPipeline")
    
    test_instance = ContentPipelineWorkflowTest()
